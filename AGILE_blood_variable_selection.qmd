...
for (tp in timepoints) {
  ...
  plot_obj <- as.ggplot(~plotLoadings(splsda_res, comp = 1, style = "ggplot2",
...
ggplots_only <- lapply(loading_plots, function(x) x)
...
# Combine them into one patchwork layout
combo2 <- wrap_plots(ggplots_only, ncol = 6)
combo2
ggsave(plot=combo2, filename = "spls-da_top_markers.png", dpi=500, height=5,width=20)
```